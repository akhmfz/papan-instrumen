...
│   ├── papan-instrumen/            ← 131 notes dari graph PI          │
│   │   ├── graph.canvas            ← Visualisasi graph (interaktif)   │
│   │   ├── Papan Instrumen ....md  ← 1 note per node                  │
│   │   └── _COMMUNITY_*.md         ← 1 note per community             │
│   ├── papan-gerak/                ← 132 notes dari graph PG          │
│   │   └── ...                     ← Sama struktur                    │
...
```
C:\Users\Akhmfz\obsidian-vault\          (264+ notes)
├── Index.md                              ← Dashboard utama (MOC)
│
├── papan-instrumen/                      ← 131 notes (auto-generated by Graphify)
│   ├── graph.canvas                      ← Graph visual (bisa dibuka & diedit)
...
│
├── papan-gerak/                          ← 132 notes (auto-generated by Graphify)
│   ├── graph.canvas
